...
import tradutor from "../../images/translate.png"
  ...
  return (
    <>
      ...
      <div className="cadastro">
        ...
        <div className="souInterprete">
                  <img src={tradutor} alt="Imagem de um usuário do sexo masculino" />
                  <Link to="/cadastro/formulario/tradutor">
                    <button>Sou tradutor</button>
                  </Link>
               </div>
      </div>
    </>
